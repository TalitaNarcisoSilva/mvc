...
<body class="bg-light d-flex flex-column min-vh-100">
    ...
    <header class="bg-dark text-white py-3">
        <div class="container">
            ...
            <div class="d-flex flex-columm flex-md-row justify-content-between align-items-center">

                <h1 class="h3 mb-3 mb-md-0"> Sistema de Cadastros </h1>
    ...
    <!---=====   Conteudo carregado pelas rotas  =====-->
    ...
    <footer class="bg-dark text-white text-center py-3">
        <p class="mb-0"> Sistema MVC de Cadastros </p>
    </footer>
